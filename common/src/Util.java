...
public class Util {
	// TODO - move these variables to a "Config" class
	...
	public static double removalPercentage = 0.5; // Percentage of transactions that should be removed. 0.25 == 25%
	public static int cleaningPeriod = 5; // (Seconds)
